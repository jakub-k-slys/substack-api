...
async function runExample(): Promise<void> {
  ...
  try {
    ...
    console.log('\n📝 Note Builder API Examples:')
    console.log('   The new builder API allows you to create rich notes with fluent syntax:')
    console.log('')
    console.log('   // Simple note:')
    console.log('   await profile.newNote("Hello world!").publish()')
    console.log('')
    console.log('   // Multiple paragraphs:')
    console.log('   await profile.newNote()')
    console.log('     .paragraph("First paragraph")')
    console.log('     .paragraph("Second paragraph")')
    console.log('     .publish()')
    console.log('')
    console.log('   // Rich formatting:')
    console.log('   await profile.newNote()')
    console.log('     .paragraph()')
    console.log('       .text("Regular text ")')
