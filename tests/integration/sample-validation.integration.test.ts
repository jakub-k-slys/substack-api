...
describe('Sample Data Validation Integration Tests', () => {
  ...
  describe('sample file structure validation', () => {
    ...
    test('should validate subscription sample has required fields', async () => {
      ...
      const requiredFields = [
        'id', 'user_id', 'publication_id', 'email_disabled', 
        'membership_state', 'is_subscribed', 'is_founding', 'is_free_subscribed'
      ]
    ...
    test('should validate profile samples have required fields', async () => {
      const profileSamples = [
        ...
        { file: 'user/jakubslys/public_profile', requiredFields: ['id', 'name', 'handle', 'photo_url', 'bio'] }
      ]
  ...
  describe('sample data realism', () => {
    ...
    test('should have realistic subscription states', async () => {
      ...
      const membershipStates = subscriptionsData.subscriptions.map((sub: any) => sub.membership_state)
      ...
      const foundingSubscriptions = subscriptionsData.subscriptions.filter((sub: any) => sub.is_founding)
